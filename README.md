...
Junior infrastructure technician based in Tokyo. Hands-on with networking, Linux, Windows Server, virtualization, and hardware. Previously at Extreme Networks preparing and validating enterprise racks for relocation.

Currently studying for CompTIA Security+, Network+, and CCNA.

Tech stack: Networking, Linux, Windows Server, Cisco IOS, VirtualBox, OpenVPN, AWS
